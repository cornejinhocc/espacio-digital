...
import { Globe, ArrowUpRight, CheckCircle2, Send, ShieldCheck, Cpu, Building2, User } from "lucide-react";
...
const content = {
  es: {
    ...
    subLabel: "ESPACIO DIGITAL — JIMMY CORNEJO",
    pillars: [
    ...
    bio: "Especialista en optimización de procesos administrativos, reestructuración de cuellos de botella operacionales y dirección de proyectos institucionales.",
  ...
  en: {
    ...
    subLabel: "DIGITAL SPACE — JIMMY CORNEJO",
    pillars: [
    ...
    bio: "Specializing in administrative process optimization, operational bottleneck elimination, and institutional project management.",
...
export default function App() {
  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ maxWidth: "1040px", margin: "0 auto", padding: "40px 24px", width: "100%", position: "relative", zIndex: 1, flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <AnimatePresence mode="wait">
          ...
          {/* HOME CON FOTO LATERAL TIPO EDITORIAL */}
          {tab === "home" && (
            <motion.main key="home" variants={pageVariants} initial="hidden" animate="visible" exit="exit" style={{ display: "flex", flexDirection: "column", gap: "40px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: "48px", alignItems: "center" }}>
                ...
                <div>
                  <div style={{ fontSize: "11px", fontFamily: "JetBrains Mono, monospace", color: "#38bdf8", letterSpacing: "0.18em", marginBottom: "16px" }}>
                    {t.subLabel}
                  </div>

                  <h1 style={{ fontSize: "72px", fontWeight: "300", color: "rgba(255, 255, 255, 0.85)", margin: 0, lineHeight: "0.95", letterSpacing: "-0.04em" }}>
                    {t.heroTitle1}
                  </h1>
                  <h1 style={{ fontSize: "72px", fontWeight: "800", color: "#ffffff", margin: "0 0 24px 0", lineHeight: "0.95", letterSpacing: "-0.04em" }}>
                    {t.heroTitle2}
                  </h1>

                  <p style={{ color: "#a1a1aa", fontSize: "15px", lineHeight: "1.7", margin: "0 0 36px 0", fontWeight: "300", maxWidth: "520px" }}>
                    {t.bio}
                  </p>
                    ...
                    {t.pillars.map((item, idx) => (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: "14px", fontWeight: "700", color: "#ffffff", letterSpacing: "-0.01em" }}>{item.title}</div>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div style={{
                  ...
                  {!imgError ? (
                    <img
                      ...
                      onMouseOver={(e) => {
                        e.currentTarget.style.filter = "grayscale(20%) contrast(100%)";
                        e.currentTarget.style.transform = "scale(1.03)";
                      }}
                      onMouseOut={(e) => {
                        e.currentTarget.style.filter = "grayscale(100%) contrast(105%)";
                        e.currentTarget.style.transform = "scale(1)";
                      }}
                    />
                  ) : (
                    <div style={{ textAlign: "center", padding: "20px", color: "#71717a" }}>
                      <User size={48} color="#38bdf8" style={{ marginBottom: "12px" }} />
                      <div style={{ fontSize: "13px", fontWeight: "600", color: "#fff" }}>Agrega tu foto en:</div>
                      <div style={{ fontSize: "11px", fontFamily: "JetBrains Mono, monospace", color: "#38bdf8", marginTop: "4px" }}>public/profile.jpg</div>
                    </div>
                  )}
                  ...
                  <div style={{
                    ...
                    right: 0,
                    padding: "16px 20px",
                    background: "linear-gradient(to top, rgba(3, 3, 8, 0.85), transparent)",
                    display: "flex",
                    justify: "space-between",
                    alignItems: "center"
                  }}>
                    <span style={{ fontSize: "11px", fontFamily: "JetBrains Mono, monospace", color: "#fff", fontWeight: "500" }}>
                      JIMMY CORNEJO
                    </span>
...
console.log("Layout de portada actualizado con sección de foto integrada!");
