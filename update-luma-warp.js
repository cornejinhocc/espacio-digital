...
function LumaStarfieldCanvas() {
  ...
  useEffect(() => {
    ...
    const colorPalette = [
      ...
      new THREE.Color("#818cf8"), // Indigo Glow
      new THREE.Color("#c084fc"), // Violet Light
    ...
    for (let i = 0; i < count; i++) {
      ...
      const len = 0.4 + Math.random() * 0.8; // Longitud de la estela
      ...
      // Colores de la estela (cabeza brillante, cola tenue)
    ...
    const animate = () => {
      ...
      for (let i = 0; i < count; i++) {
        ...
        // Si la estrella sobrepasa la cámara, reiniciarla al fondo
        if (star.z > 2) {
          star.z = -30;
      ...
      // Movimiento suave de cámara según ratón
...
console.log("Fondo estilo estrellas fugaces de Luma generado correctamente!");
